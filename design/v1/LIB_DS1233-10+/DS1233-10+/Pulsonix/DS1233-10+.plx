...
(library Library_1
	...
	(patternDef "TO-92" (originalName "TO-92")
		...
		(layerContents (layerNumRef 18)
			(attr "RefDes" "RefDes" (pt 1.6, -0.2) (textStyleRef "Normal") (isVisible True))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "DS1233-10+" (originalName "DS1233-10+") (compHeader (numPins 3) (numParts 1) (refDesPrefix IC)
		...
		(compPin "2" (pinName "__RST") (partNum 1) (symPinNum 2) (gateEq 0) (pinEq 0) (pinType Input))
		...
		(attr "<Hyperlink>" "https://datasheet.datasheetarchive.com/originals/distributors/Datasheets-18/DSA-345030.pdf")
		(attr "<STEP Filename>" "DS1233-10+.stp")
		(attr "<STEP Offsets>" "X=0;Y=0;Z=6.09")
